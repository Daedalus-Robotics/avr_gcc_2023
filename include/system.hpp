...
#ifndef AVR_GCC_2023_SYSTEM_HPP
#define AVR_GCC_2023_SYSTEM_HPP
...
#define HANDLE_ROS_ERROR(rc, do_reset) handleError(rc, do_reset, __FILE__, __PRETTY_FUNCTION__, __LINE__)
...
#define CONTEXT_PARAMETER_CALLBACK(cls, func) [](const rcl_interfaces__msg__Parameter *old_param, \
                                                const rcl_interfaces__msg__Parameter *new_param,   \
                                                void *void_context)                               \
{                                                                                                 \
    auto context = (cls *) void_context;                                                          \
    return context->func(old_param, new_param);                                                          \
}
